...
def gameWindow():
    ...
    # Declaring Wining msg
    winingmsg = canvas2.create_text(screen_width/2 + 10, screen_height/2 + 250, text = "", font=("Chalkboard SE",100), fill='#fff176')
...
def handleResetGame():
    ...
    canvas2.itemconfigure(winingmsg, text="")
    resetButton.destroy()
...
def recivedMsg():
    ...
    while True:
        ...
        #if('player1Turn' and playerType == 'player1'):
            #playerTurn = True
            #rollButton = Button(gameWindow , text = "Roll Dice" , fg = "black" ,  font=("Chalkboard",15) , bg = "grey" , command=rollDice , width=20 , height=5)
            #rollButton.place(x=screen_width/2-80 , y = screen_height/2+250)
        
        #elif('player2Turn' and playerType == 'player2'):
            #playerTurn = True
            #rollButton = Button(gameWindow , text = "Roll Dice" , fg = "black" ,  font=("Chalkboard",15) , bg = "grey" , command=rollDice , width=20 , height=5)
...
def handlewin(msg):
    ...
    msg = msg.split(".")[0] + "."
    canvas2.itemconfigure(winingmsg,text = msg)
